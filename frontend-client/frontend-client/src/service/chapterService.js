...
const chapterService = {
    ...
    // Get total followers by book ID
getTotalFollowersByBookId: async (bookId) => {
    try {
        const response = await axios.get(`https://api.it-ebook.io.vn/api/books/${bookId}/followers`);
        return response.data;
    } catch (error) {
        throw error;
    }
